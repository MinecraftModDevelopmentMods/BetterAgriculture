...
public class TinyTileBlock extends BlockBase {
	public static final IProperty<EnumType> VARIANT = PropertyEnum.create("variant", EnumType.class);

	public TinyTileBlock(final Material materialIn) {
		super(materialIn, "tinytile");
	}
	...
	public enum EnumType implements IVariant {
		...
		TINYTILE_RED(1, "red"),
		TINYTILE_PURPLE(2, "purple"),
		TINYTILE_PINK(3, "pink"),
		TINYTILE_ORANGE(4, "orange"),
		TINYTILE_MAGENTA(5, "magenta"),
		TINYTILE_LIME(6, "lime"),
		TINYTILE_LIGHTGREY(7, "lightgrey"),
		TINYTILE_LIGHTBLUE(8, "lightblue"),
		TINYTILE_GREY(9, "grey"),
		TINYTILE_GREEN(10, "green"),
		TINYTILE_CYAN(11, "cyan"),
		TINYTILE_BROWN(12, "brown"),
		TINYTILE_BLUE(13, "blue"),
		TINYTILE_YELLOW(14, "yellow");
