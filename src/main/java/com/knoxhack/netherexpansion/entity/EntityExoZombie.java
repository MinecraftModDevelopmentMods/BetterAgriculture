...
public class EntityExoZombie extends EntityMob
{
    ...
    /** Ticker used to determine the time remaining for this exozombie to convert into a villager when cured. */
    ...
    public EntityExoZombie(World worldIn)
    {
        super(worldIn);
