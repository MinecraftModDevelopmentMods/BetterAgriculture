...
public class EntityMobPig7 extends EntityAnimal
{
    private static final DataParameter<Boolean> SADDLED = EntityDataManager.<Boolean>createKey(EntityMobPig7.class, DataSerializers.BOOLEAN);
    ...
    public EntityMobPig7(World worldIn)
    {
        super(worldIn);
    ...
    public EntityMobPig7 createChild(EntityAgeable ageable)
    {
        return new EntityMobPig7(this.worldObj);
    }
