...
public class EntityMobPig5 extends EntityAnimal
{
    private static final DataParameter<Boolean> SADDLED = EntityDataManager.<Boolean>createKey(EntityMobPig5.class, DataSerializers.BOOLEAN);
