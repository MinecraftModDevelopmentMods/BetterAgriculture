...
public class EntityMobSheep4 extends EntityAnimal implements net.minecraftforge.common.IShearable
{
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(EntityMobSheep4.class, DataSerializers.BYTE);
    /**
    ...
    {
        EntityMobSheep4 entitysheep = (EntityMobSheep4)ageable;
        EntityMobSheep4 entitysheep1 = new EntityMobSheep4(this.worldObj);
    ...
    {
        int i = ((EntityMobSheep4)father).getFleeceColor().getDyeDamage();
        int j = ((EntityMobSheep4)mother).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((EntityMobSheep4)father).worldObj);
        int k;
