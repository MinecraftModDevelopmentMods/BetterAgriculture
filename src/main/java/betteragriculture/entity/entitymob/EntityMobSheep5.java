...
public class EntityMobSheep5 extends EntityAnimal implements net.minecraftforge.common.IShearable
{
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(EntityMobSheep5.class, DataSerializers.BYTE);
    /**
    ...
    public EntityMobSheep5(World worldIn)
    {
        super(worldIn);
    ...
    public EntityMobSheep5 createChild(EntityAgeable ageable)
    {
        EntityMobSheep5 entitysheep = (EntityMobSheep5)ageable;
        EntityMobSheep5 entitysheep1 = new EntityMobSheep5(this.worldObj);
    ...
    {
        int i = ((EntityMobSheep5)father).getFleeceColor().getDyeDamage();
        int j = ((EntityMobSheep5)mother).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((EntityMobSheep5)father).worldObj);
        int k;
