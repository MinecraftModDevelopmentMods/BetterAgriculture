...
public class EntityMobPig10 extends EntityAnimal
{
    private static final DataParameter<Boolean> SADDLED = EntityDataManager.<Boolean>createKey(EntityMobPig10.class, DataSerializers.BOOLEAN);
    ...
    {
        return new EntityMobPig10(this.worldObj);
    }
