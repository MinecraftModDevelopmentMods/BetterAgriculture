...
public class EntityMobSheep8 extends EntityAnimal implements net.minecraftforge.common.IShearable
{
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(EntityMobSheep8.class, DataSerializers.BYTE);
    /**
    ...
    {
        EntityMobSheep8 entitysheep = (EntityMobSheep8)ageable;
        EntityMobSheep8 entitysheep1 = new EntityMobSheep8(this.worldObj);
    ...
    {
        int i = ((EntityMobSheep8)father).getFleeceColor().getDyeDamage();
        int j = ((EntityMobSheep8)mother).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((EntityMobSheep8)father).worldObj);
        int k;
