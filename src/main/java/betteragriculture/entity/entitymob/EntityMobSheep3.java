...
public class EntityMobSheep3 extends EntityAnimal implements net.minecraftforge.common.IShearable
{
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(EntityMobSheep3.class, DataSerializers.BYTE);
    /**
    ...
    {
        EntityMobSheep3 entitysheep = (EntityMobSheep3)ageable;
        EntityMobSheep3 entitysheep1 = new EntityMobSheep3(this.worldObj);
    ...
    {
        int i = ((EntityMobSheep3)father).getFleeceColor().getDyeDamage();
        int j = ((EntityMobSheep3)mother).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((EntityMobSheep3)father).worldObj);
        int k;
