...
public class EntityMobPig3 extends EntityAnimal
{
    private static final DataParameter<Boolean> SADDLED = EntityDataManager.<Boolean>createKey(EntityMobPig3.class, DataSerializers.BOOLEAN);
    ...
    {
        return new EntityMobPig3(this.worldObj);
    }
