...
public class EntityMobSheep1 extends EntityAnimal implements net.minecraftforge.common.IShearable
{
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(EntityMobSheep1.class, DataSerializers.BYTE);
    /**
    ...
    {
        EntityMobSheep1 entitysheep = (EntityMobSheep1)ageable;
        EntityMobSheep1 entitysheep1 = new EntityMobSheep1(this.worldObj);
    ...
    {
        int i = ((EntityMobSheep1)father).getFleeceColor().getDyeDamage();
        int j = ((EntityMobSheep1)mother).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((EntityMobSheep1)father).worldObj);
        int k;
