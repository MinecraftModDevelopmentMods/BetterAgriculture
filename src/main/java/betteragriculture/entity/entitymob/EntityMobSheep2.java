...
public class EntityMobSheep2 extends EntityAnimal implements net.minecraftforge.common.IShearable
{
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(EntityMobSheep2.class, DataSerializers.BYTE);
    /**
    ...
    {
        EntityMobSheep2 entitysheep = (EntityMobSheep2)ageable;
        EntityMobSheep2 entitysheep1 = new EntityMobSheep2(this.worldObj);
    ...
    {
        int i = ((EntityMobSheep2)father).getFleeceColor().getDyeDamage();
        int j = ((EntityMobSheep2)mother).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((EntityMobSheep2)father).worldObj);
        int k;
