...
public class EntityMobSheep10 extends EntityAnimal implements net.minecraftforge.common.IShearable
{
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(EntityMobSheep10.class, DataSerializers.BYTE);
    /**
    ...
    {
        EntityMobSheep10 entitysheep = (EntityMobSheep10)ageable;
        EntityMobSheep10 entitysheep10 = new EntityMobSheep10(this.worldObj);
        entitysheep10.setFleeceColor(this.getDyeColorMixFromParents(this, entitysheep));
        return entitysheep10;
    }
    ...
    {
        int i = ((EntityMobSheep10)father).getFleeceColor().getDyeDamage();
        int j = ((EntityMobSheep10)mother).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((EntityMobSheep10)father).worldObj);
        int k;
