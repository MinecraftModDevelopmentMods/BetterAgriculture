...
public class EntityMobSheep6 extends EntityAnimal implements net.minecraftforge.common.IShearable
{
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(EntityMobSheep6.class, DataSerializers.BYTE);
    /**
    ...
    {
        EntityMobSheep6 entitysheep = (EntityMobSheep6)ageable;
        EntityMobSheep6 entitysheep1 = new EntityMobSheep6(this.worldObj);
    ...
    {
        int i = ((EntityMobSheep6)father).getFleeceColor().getDyeDamage();
        int j = ((EntityMobSheep6)mother).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((EntityMobSheep6)father).worldObj);
        int k;
