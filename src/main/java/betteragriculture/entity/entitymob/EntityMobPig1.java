...
public class EntityMobPig1 extends EntityAnimal
{
    private static final DataParameter<Boolean> SADDLED = EntityDataManager.<Boolean>createKey(EntityMobPig1.class, DataSerializers.BOOLEAN);
    ...
    {
        return new EntityMobPig1(this.worldObj);
    }
