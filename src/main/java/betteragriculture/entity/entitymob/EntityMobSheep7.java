...
public class EntityMobSheep7 extends EntityAnimal implements net.minecraftforge.common.IShearable
{
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(EntityMobSheep7.class, DataSerializers.BYTE);
    /**
    ...
    {
        EntityMobSheep7 entitysheep = (EntityMobSheep7)ageable;
        EntityMobSheep7 entitysheep1 = new EntityMobSheep7(this.worldObj);
    ...
    {
        int i = ((EntityMobSheep7)father).getFleeceColor().getDyeDamage();
        int j = ((EntityMobSheep7)mother).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((EntityMobSheep7)father).worldObj);
        int k;
