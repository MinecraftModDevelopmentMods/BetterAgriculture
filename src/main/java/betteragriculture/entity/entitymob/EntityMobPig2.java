...
public class EntityMobPig2 extends EntityAnimal
{
    private static final DataParameter<Boolean> SADDLED = EntityDataManager.<Boolean>createKey(EntityMobPig2.class, DataSerializers.BOOLEAN);
    ...
    {
        return new EntityMobPig2(this.worldObj);
    }
