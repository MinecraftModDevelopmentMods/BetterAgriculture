...
public class EntityMobPig9 extends EntityAnimal
{
    private static final DataParameter<Boolean> SADDLED = EntityDataManager.<Boolean>createKey(EntityMobPig9.class, DataSerializers.BOOLEAN);
