...
public class EntityMobSheep9 extends EntityAnimal implements net.minecraftforge.common.IShearable
{
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(EntityMobSheep9.class, DataSerializers.BYTE);
    /**
    ...
    {
        EntityMobSheep9 entitysheep = (EntityMobSheep9)ageable;
        EntityMobSheep9 entitysheep1 = new EntityMobSheep9(this.worldObj);
    ...
    {
        int i = ((EntityMobSheep9)father).getFleeceColor().getDyeDamage();
        int j = ((EntityMobSheep9)mother).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((EntityMobSheep9)father).worldObj);
        int k;
