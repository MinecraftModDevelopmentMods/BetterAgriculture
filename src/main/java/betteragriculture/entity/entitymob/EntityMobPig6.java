...
public class EntityMobPig6 extends EntityAnimal
{
    private static final DataParameter<Boolean> SADDLED = EntityDataManager.<Boolean>createKey(EntityMobPig6.class, DataSerializers.BOOLEAN);
    ...
    {
        return new EntityMobPig6(this.worldObj);
    }
